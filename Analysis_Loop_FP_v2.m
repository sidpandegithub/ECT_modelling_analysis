...
sim_folder   = 'C:\Users\z5171263\OneDrive - UNSW\Desktop\analysis\albert_road_FP_simulation';
...
for s = 1:length(nii_files)
    ...
    sim_subj_folder = fullfile(sim_folder, [subj_id '_FrontoParietal_simulation_results']);
    ...
    ROI(24).id = 2002; ROI(24).name = 'RH_CaudalAnteriorCingulate';
    ROI(16).id = 2003; ROI(16).name = 'RH_CaudalMiddleFrontal';
    ROI(17).id = 2012; ROI(17).name = 'RH_LateralOrbitofrontal';
    ROI(25).id =2014; ROI(25).name = 'RH_MedialOrbitofrontal';
    ...
    ROI(26).id = 2023; ROI(26).name = 'RH_PosteriorCingulate';
...
% save as excel file
writetable(summary_table, fullfile(sim_folder, 'albert_road_FP_sim_ROI_summary.xls'), 'WriteRowNames', true);