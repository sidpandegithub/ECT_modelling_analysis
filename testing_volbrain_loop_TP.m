...
sim_root          = 'C:\Users\z5171263\Downloads\Northside_TP_sims';
...
for s = 1:length(subj_folders)
    ...
    mesh_search = dir(fullfile(sim_root, ['edited_' subj_id '_TemporoParietal_simulation_results'], ...
...
disp(summary_table);
writetable(summary_table, fullfile(sim_root, 'assemblynet_TP_sim_ROI_summary.xls'), 'WriteRowNames', true);